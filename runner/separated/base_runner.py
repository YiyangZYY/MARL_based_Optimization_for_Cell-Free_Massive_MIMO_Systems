...
class Runner(object):
    def __init__(self, config):
        ...
        if self.all_args.algorithm_name == "happo":
            from algorithms.algorithm.happo import HAPPO as TrainAlgo
            from algorithms.algorithm.happo_policy import HAPPO_Policy as Policy
        elif self.all_args.algorithm_name == "hatrpo":
            from algorithms.algorithm.hatrpo import HATRPO as TrainAlgo
            from algorithms.algorithm.hatrpo_policy import HATRPO_Policy as Policy
        elif self.all_args.algorithm_name == "rmappo" or self.all_args.algorithm_name == "mappo":
    ...
    def train(self):
        ...
        for agent_id in range(self.num_agents):
            ...
            available_actions = None if self.buffer[agent_id].available_actions is None \
                                                                              ...
                                                                              2:])
            if self.all_args.algorithm_name == "hatrpo" or self.all_args.algorithm_name == "happo":
